...
public class PanelTarjetas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PanelTarjetaNaranja
     */
    ...
    private void initComponents() {
        ...
        jLabel5.setText("DNI del titular de la tarjeta");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelTarjetas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelTarjetas().setVisible(true);
            }
        });
    }
